...
// ----------------------------------------------------------------------------------------------
	...
	function load_stats($game_type,$sort_by,$sort_direction,$start,$stop) {
		//print 'hola '.$type;
		global $db_record,$db_bnet,$db_profile,$db_record,$game,$type;
...
if ($team_rank==1) 
 $this->stats[$n][$game.'ladder_pow'] ='st';

else
if (($team_rank==2))
$this->stats[$n][$game.'ladder_pow'] ='nd';
else
if (($team_rank==3))
$this->stats[$n][$game.'ladder_pow'] ='rd';
else
$this->stats[$n][$game.'ladder_pow'] ='th';
