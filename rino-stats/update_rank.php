...
$query='select * from record where w3xp_solo_level>0 order by w3xp_solo_xp desc limit 1000';
...
$query='select * from record where w3xp_team_level>0 order by w3xp_team_xp desc limit 1000';
$result=mysql_query($query);
$registros=mysql_num_rows($result);
...
$query='select * from record where w3xp_ffa_level>0 order by w3xp_ffa_xp desc limit 1000';
$result=mysql_query($query);
$registros=mysql_num_rows($result);
