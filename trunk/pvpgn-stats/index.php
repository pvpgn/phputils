...
$menu_games = array("theme_file"=>"menu_entry.html",
	...
	array("name"=>"Warcraft 3","code"=>"WAR3","type"=>"solo"),
	array("name"=>"Warcraft 3: Frozen Throne","code"=>"W3XP","type"=>"solo"));
...
if($current_page > 0) {
	$control_first = "[ <a href=\"index.php?game=$game&amp;type=$type&amp;sortBy=$sortBy&amp;current_page=0\">First</a> ]";
	$control_prev = " [ <a href=\"index.php?game=$game&amp;type=$type&amp;sortBy=$sortBy&amp;current_page=".($current_page - 1)."\">Previous</a> ] ";
}

if($current_page < $max_pages) {
	$control_next = "[ <a href=\"index.php?game=$game&amp;type=$type&amp;sortBy=$sortBy&amp;current_page=".($current_page + 1)."\">Next</a> ]";
	$control_last = " [ <a href=\"index.php?game=$game&amp;type=$type&amp;sortBy=$sortBy&amp;current_page=$max_pages\">Last</a> ]";
}
...
if(!isset($user)||$user=="") {
	...
	$page_data = array("stats_version"=>$stats_version,"site_theme"=>$site_theme,"game_search"=>$game_type,"content"=>$display_stats,"menu"=>$menu_games,"submenu"=>$sub_menu);
